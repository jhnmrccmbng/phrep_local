              ...
              <div class="col-lg-6">
                  ...
                  <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        $getrlfile = $obj->fetch_record_with_where("document_postapproval", $where);
                  ...
                  <form action = "researcher_action.php" method = "POST" enctype = "multipart/form-data" class="form-horizontal">  
                        <div class="row">    
                              <div class="col-lg-12">
                                  ...
                                  <select id="doctype" name="doctype" class="form-control" required="required">
                                    ...
                                    $getdocs = $obj->grouptwopa($subid);
                                    foreach($getdocs as $dc){                                        
                                        $getdoctoresubmit = $obj->getdoctoresubmitpa($subid, $dc['doctype'], $dc['doctypetimes'], $ppaid);
                          ...
                          <div class="row">    
                              <div class="col-lg-12">           
                                  <fieldset> 
                                      ...
                                      ?>
                                       <input id="ppaid" name="ppaid" type="hidden" value="<?php echo $ppaid; ?>">
                                  ...
                                  <span class="btn btn-default btn-file">
                                      <input type = "file" name = "resubmitpa" accept="application/pdf"/>                        
                                  </span>
                        ...
                        <h2>Upload Additional File (Optional)</h2>
                        <form action = "researcher_action.php" method = "POST" enctype = "multipart/form-data" class="form-horizontal">    
                          
                          <input type="button" class="btn btn-primary" onclick="showAddFiles()" value="Open here">
                              ...
                              <div class="col-lg-12"><br>
                                  <div class="panel panel-default">
                                      <div class="panel-body">
                                        ...
                                        <span class="btn btn-default btn-file">
                                            <input type = "file" name = "addsupfilepa" required/>                        
                                        </span>
                                        <input type = "submit" class="btn btn-success"/>
                                      </div>
                                  </div>
                                 ...
                                 ?>
                                    ...
                                    <div class="row"><!--THIS IS THE BUTTON--><hr>
                                        ...
                                        <input id="submid" name="submid" type="hidden" value="<?php echo $subid;?>">
                                          ...
                                          <div class="col-lg-12"><small>*Please double check documents submitted before clicking "Resubmit".</small><br>           
                                              <button type="submit" name="resubmitfilespa" class="btn btn-info btn-lg" <?php echo $d;?>>Resubmit</button>
                  ...
                  <div class="row">
                      <div class="panel panel-default">
                        ...
                        <table class="table table-bordered">
                            ...
                            <?php 
                            $ppt = $obj->getMaxValueofppa($id);
                            $maxrev = $obj->getmaxrevision($id, $ppt);
                                    ...
                                    if(($files['kind'] == 'MP') || ($files['kind'] == 'SF')){
                                        ...
                                        if($files['finaldoc'] == '1'){
                                            ...
                                            if($files['newsubmit'] == '1'){
                                                echo '<td>'.$files['file_name'].' ('.$files['doctypetimes'].') ';
                                                echo '<br><small><strong>New</strong> | '.$obj->ordinalize($files['revision']).' version | Uploaded: ';
                                                echo ''.date("M j, Y",strtotime($files['date_uploaded'])).'</small></td>';
                                                
                                                echo '<td class="text-center"><a class="btn btn-danger btn-xs" href="#" data-href="researcher_action.php?deletedocpa=1&id='.$files['file_id'].'&sid='.$files['sub_id'].'" data-toggle="modal" data-target="#confirm-delete" role="button">';
                                                echo '<span class="glyphicon glyphicon-remove" aria-hidden="true"></a>';
                                                echo '</span></td>';
                                            }
                                            else {
//                                                echo '<td>'.$files['file_name'].' ('.$files['doctypetimes'].') ';
//                                                echo '<br><small>'.$obj->ordinalize($files['revision']).' version | Uploaded: ';
//                                                echo ''.date("M j, Y",strtotime($files['date_uploaded'])).'</small></td>'; 
//                                                
//                                                

                          ...
                          <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                        ...
                                        <div class="form-group"> 
                                          ...
                                          <div class="col-md-7">
                                            <h4>Select for Primary Reviewers</h4>
...
<!--                                            </select>
                                              ...
                                              <table class="table table-condensed table-bordered">
                                                  <tr>
                                                      ...
                                                      <?php 
                                                        ...
                                                        $checkChairman = $obj->getassignedrev($userid, $id);
                                                        if($checkChairman){
                                                            foreach($checkChairman as $row){
                                                                echo '<tr>';
                                                                echo '<td><input type="checkbox" name="prev[]" id="rev'.$row[puser].'" value="'.$row[puser].'"></td>';
                                                                echo '<td>'.$row[fname].' '.$row[mname].' '.$row[lname].'</td>';
                                                                echo '</tr>';
                                                            }
                                                        }
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-md-7">
                                            <button id="confirmexpedited" name="assignprimary" class="btn btn-primary">Assign</button>

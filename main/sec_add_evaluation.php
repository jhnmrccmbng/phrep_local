      ...
      <div class="container-fluid">
          ...
          <div class="row">
              <div class="row">
                  ...
                  <div class="col-lg-1"><br><a class="btn btn-success" href="" role="button">Add Evaluation Form</a></div>
                  <div class="col-lg-8"><h2><center>Add Evaluation Forms</center></h2></div>
                        ...
                        <tr>
                            ...
                            if($getForm){
                                foreach($getForm as $form){
                                    echo '<td><center><a class="btn btn-default" href="#" role="button"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>&nbsp;
                                        <a class="btn btn-default" href="#" role="button"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a></center></td>
                                        <td>'.$form[fid].'</td>

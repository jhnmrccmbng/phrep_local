                            ...
                            <div class="panel panel-default">
                                <table class="table table-condensed table-bordered table-hover">
                                   ...
                                   <?php
                                        ...
                                        $sitevisitdecisions = $obj->getmaxsitevisitsub($id, $maxppaid);
                                        for($i=$sitevisitdecisions;$i>=1;$i--){
                                            
                                            if ($i == $sitevisitdecisions) {
                                            ...
                                            $where = array("submission" => $i, "subid" =>$id, "ppaid" => $maxppaid);
                                            $getrevdecision = $obj->fetch_record_with_where("sitevisit_decision", $where);
                                            foreach($getrevdecision as $revdes){
                                                if($revdes['decision'] == '1'){$dec = "Acknowledged";} else if($revdes['decsion'] == '2'){$dec = "Needs Additional Info";} else if($revdes['decsion'] == '6'){$dec = "Terminated";}
                                                
                                                $where = array("id" => $revdes['username']);
                                                $fetchuser = $obj->fetch_record_with_where("phrepuser", $where);
                                                foreach($fetchuser as $user){$fullname = $user['fname'].' '.$user['mname'].' '.$user['lname'];}
                                                
                                                $where1 = array("file_id" => $revdes['fileid']);
                                                $fetchdoc = $obj->fetch_record_with_where("document_sitevisit", $where1);
                                                
                                                if($fetchdoc){
                                                
                                                    foreach($fetchdoc as $doc){$path = $doc['path']; $filename = $doc['file_name'];}


                                                    echo '<tr><td>'.$fullname.'</td>';
                                                    echo '<td>'.$dec;

                                                    echo '<span class="pull-right"><a data-toggle="tooltip" title="DOWNLOAD" class="btn btn-success btn-xs" href="'.$path.'" role="button"><span class="glyphicon glyphicon-cloud-download" aria-hidden="true"></span></a>
                                                          <a data-toggle="tooltip" title="VIEW" target = "_blank" href="https://docs.google.com/gview?url=http://phrep.pchrd.dost.gov.ph/main/uploads/main/'.$filename.'&embedded=true" class="btn btn-primary btn-xs" role="button"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a></span> ';
                                                    ...
                                                    echo '<span class="pull-right"><i>No Document</i></span> ';
                ...
                <div class="col-lg-2">  
                    ...
                    foreach($requesttype as $rt){
                        ...
                        ?>
                            <div class="panel panel-default">
                                <div class="panel-body"><h5 class="text-center">Tag Proposal</h5>
                                    ...
                                    <a class="btn btn-danger btn-lg btn-block" href="disapproved_amendments.php?id=<?php echo $id;?>" role="button">Disapprove</a>
                                    <a class="btn btn-danger btn-lg btn-block" href="#?id=<?php echo $id;?>" role="button">Terminate</a>
                        ...
                        ?>
                            <div class="panel panel-default">
                                <div class="panel-body"><h5 class="text-center">Tag Proposal</h5>
                                    <a class="btn btn-primary btn-lg btn-block" href="sec_approve_pr.php?id=<?php echo $id;?>" role="button">Approve</a>
                                    <a class="btn btn-warning btn-lg btn-block" href="sec_revisepa.php?id=<?php echo $id;?>" role="button">Revise</a>
                                    <a class="btn btn-danger btn-lg btn-block" href="#?id=<?php echo $id;?>" role="button">Disapprove</a>
                                    <a class="btn btn-danger btn-lg btn-block" href="#?id=<?php echo $id;?>" role="button">Terminate</a>
                                    <a class="btn btn-info btn-lg btn-block" href="site_visitpa.php?id=<?php echo $id;?>" role="button">Site Visit</a>
                                    <button type="button" class="btn btn-default btn-lg btn-block" onclick="goBack()">Cancel</button>
                                </div>
                        ...
                        ?>
                            <div class="panel panel-default">
                                <div class="panel-body"><h5 class="text-center">Tag Proposal</h5>
                                    <a class="btn btn-primary btn-lg btn-block" href="sec_approve_fr.php?id=<?php echo $id;?>" role="button">Approve</a>
                                    <a class="btn btn-warning btn-lg btn-block" href="sec_revisepa.php?id=<?php echo $id;?>" role="button">Revise</a>
                                    <a class="btn btn-danger btn-lg btn-block" href="disapproved_amendments.php?id=<?php echo $id;?>" role="button">Disapprove</a>
                                    <a class="btn btn-danger btn-lg btn-block" href="#?id=<?php echo $id;?>" role="button">Terminate</a>
                                    <a class="btn btn-info btn-lg btn-block" href="site_visitpa.php?id=<?php echo $id;?>" role="button">Site Visit</a>

...
$getUserUpdate = $obj->getUser("phrepuser", $where);
    if($getUserUpdate){?>
          ...
          <div class="row"><h2><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Request for Ethical Clearance Extension</h2><hr>
          ...
          <div class="row">
              <div class="col-lg-12">
                  <h2>Upload Ethical Clearance Form<small> Required</small></h2>
              </div>
          </div>
          <div class="row">   
              <div class="col-lg-6">                  
                      <form action = "researcher_action.php" method = "POST" enctype = "multipart/form-data" class="form-horizontal">
                          <input name="dlfile" type="hidden" value="NECForm-ProgressReportforExtensionofEthicalClearance_ver1.docx">
                          <div class="panel panel-default">
                              <div class="panel-body">
                                  <h4 class="pull-left">Ethical Clearance Form<br><small>You can download the form and provide content, then, upload it.</small></h4>
                  ...
                  <div class="col-lg-6">
                      <form action = "researcher_action.php" method = "POST" enctype = "multipart/form-data" class="form-horizontal">
                         ...
                         <?php $getmaxtimes = $obj->getmaxtimes($subid);
                          ...
                          ?>
                            <input id="doctype" name="doctype" type="hidden" value="21,EthicalClearanceForm">
                            <div class="panel panel-default">
                              <div class="panel-body">
                                <h4>Upload Your Form Here!</h4>
                                  <span class="btn btn-default btn-file">
                                      <input type = "file" name = "uploadecemain" required="required"/>                        
                                  </span>
         ...
         <form action = "researcher_action.php" method = "POST" enctype = "multipart/form-data" class="form-horizontal">   
              <div class="row">
                ...
                <div class="col-lg-6">           
                    ...
                    <span class="btn btn-default btn-file">
                    <input type = "file" name = "uploadece" required="required"/>                        
                    </span>
                    <input type = "submit" class="btn btn-success"/>
                </div>
            ...
            <form action = "researcher_action.php" method = "POST" enctype = "multipart/form-data" class="form-horizontal">     
              ...
              <input id="userid" name="userid" type="hidden" value="<?php echo $userid; ?>">
                  ...
                  <div class="col-lg-10"><center><small>*Once clicked "Done Resubmit", it cannot be undone.</small> <br>    
                          <?php
                          $where = array("sub_id" => $subid, "kind" => "ECF", "doctype" => 21, "newsubmit" => '1');
                          ...
                          <button type="submit" name="requestextension" class="btn btn-info" <?php echo $bt; ?> >Apply Extension</button>

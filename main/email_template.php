...
<td bgcolor="#00969c" align="center" class="section-padding" style="padding: 30px 15px 0px 15px;">
            <table border="0" cellpadding="0" cellspacing="0" width="500" style="padding: 0 0 20px 0;" class="responsive-table">
<!-- TITLE --><tbody><tr>
<td align="center" class="padding-copy" colspan="2" style="padding: 0 0 10px 0px; font-size: 75px; font-family: 'Raleway', sans-serif; font-weight: normal; color: #ffffff;">PHREP<br><p style="padding: 0 0 10px 0px; font-size: 25px; font-family: 'Raleway', sans-serif; font-weight: normal; color: #ffffff;">Philippine Health Research Ethics Portal</p></td>
                </tr></tbody>
</table>
</td>
    </tr></tbody></table>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%" id="ko_titleBlock_7"><tbody><tr class="row-a">
<td bgcolor="#EDE8DA" align="center" class="section-padding" style="padding: 30px 15px 0px 15px;">
            <table border="0" cellpadding="0" cellspacing="0" width="500" style="padding: 0 0 0 0;" class="responsive-table">
<!-- TITLE --><tbody><tr>
<td align="center" class="padding-copy" colspan="2" style="padding: 0 0 0px 0px; font-size: 25px; font-family: 'Raleway', sans-serif; font-weight: normal; color: #3F3D33;">EXEMPTED</td>
                </tr></tbody>
</table>
</td>
    </tr></tbody></table>
...
<p style="text-align: left;" data-mce-style="text-align: left;">Dear <strong>{researcher_lastname}</strong>,</p>
<p style="text-align: left;" data-mce-style="text-align: left;">
<p style="text-align: left;" data-mce-style="text-align: left;">A preliminary evaluation for the study "{ptitle}" was conducted by the {RECName} and the Committee deems  that the project is <strong>exempted from review</strong>. Please see attached letter.</p>
<hr>
<p style="text-align: left;" data-mce-style="text-align: left;">Thank you,<br><i>{secretary_fullname}</i></p>
</td>
                                        </tr>
</tbody></table>
</td>
...
<td bgcolor="#00969c" align="center" class="section-padding" style="padding: 10px 15px 0px 15px;">

              ...
              <div class="col-lg-10"><h2>Decision - Disapprove
                      <small class="pull-right">
                          ...
                          foreach($request as $req){
                                ...
                                foreach($reqname as $req){echo $req['par_desc']; $req_type = '1'; $docname="TerminateEthicalExtension"; $doctype = "51"; $st = "36";}
                                }
                                else if($req['pa_request'] == 2){
                                    $where = array("id"=>"2");
                                    $reqname = $obj->fetch_record_with_where("post_approval_reqtype", $where);
                                    foreach($reqname as $req){echo $req['par_desc']; $req_type = '2'; $docname="TerminateAmendments"; $doctype = "52"; $st = "37";} 

                                }
                                else if($req['pa_request'] == 3){
                                    $where = array("id"=>"3");
                                    $reqname = $obj->fetch_record_with_where("post_approval_reqtype", $where);
                                    foreach($reqname as $req){echo $req['par_desc']; $req_type = '3'; $docname="TerminateProgressReport"; $doctype = "53"; $st = "38";}

                                }
                                else if($req['pa_request'] == 4){
                                    $where = array("id"=>"4");
                                    $reqname = $obj->fetch_record_with_where("post_approval_reqtype", $where);
                                    foreach($reqname as $req){echo $req['par_desc']; $req_type = '4'; $docname="TerminateFinalReport"; $doctype = "54"; $st = "39";}
                            ...
                            <div class="panel-body">
                                <form action = "sec_dashboard_action.php" method = "POST" enctype = "multipart/form-data" class="form">
                                  ...
                                  <h4>Attached Decision Letter:</h4>       
                                            ...
                                            <input name="kind" type="hidden" value="T<?php echo $req_type;?>">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <input id="attach" type = "file" name = "terminate" require/>  
                                                </span>                      
                                                <input id="attached" type = "submit" name="clearance" class="btn btn-primary"/>
                                            </div>
                                        </div>
                                        <?php 
                                        $where = array("sub_id" => $id, "doctype" => "$doctype", "kind" => "T$req_type", "finaldoc" => "1");
...
//                                               echo ' <input id="ecpath" name="ecpath" type="hidden" value="'.$clear['path'].'">';
                                               ...
                                               echo '<div class="alert alert-success" role="alert">
                                                        ...
                                                        <a href="#" data-toggle="modal" data-target="#confirm-deletesitedoc" data-href="sec_dashboard_action.php?erase=1&id='.$clear['file_id'].'&subid='.$id.'&loc=sec_terminatepa"><span class="glyphicon glyphicon-remove pull-right" aria-hidden="true"></span></a>
                                                    </div>';
...
//                                               $ecpath = $clear['path'];
                                ...
                                <hr>
                                    ...
                                    ?>      
                                        ...
                                        <?php 
                                        $getmaxrl = $obj->document_decision_letter($id,"T$req_type");
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6"><center>
                                                    <button name="terminatepostapproval" type="submit" id="form-submit" class="btn btn-danger" <?php echo $d;?>>TERMINATE</button> </center>
                                            </div>
                                            <div class="col-lg-3">
                                            </div>
                                        </div>

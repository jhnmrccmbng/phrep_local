                                    ...
                                    <div class="panel-body">
                                      <form action = "sec_dashboard_action.php" method = "POST" enctype = "multipart/form-data" class="form">
                                          ...
                                          <h4>Attached Ethical Clearance:</h4>       
                                                    ...
                                                    <?php
                                                    $getmaxec = $obj->getMaxRevisionECpa($id);
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6"><center><div class="alert alert-danger" role="alert">Please double check before approving.</div>
                                                        ...
                                                        <?php 
                                                        $getMaxRevisionEC = $obj->getMaxRevisionECpa($id);
                              ...
                              <form action = "sec_dashboard_action.php" method = "POST" enctype = "multipart/form-data" class="form">
                                  ...
                                  <h4>Attached Ethical Clearance:</h4>       
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <span class="btn btn-default btn-file">
                                                    <input id="attach" type = "file" name = "imagepa" />  
                                                    </span>                      
                                                    <input id="attached" type = "submit" name="clearancepa" class="btn btn-primary"/>
                                                </div>
                                            </div>
                                        </form>
                                ...
                                $where = array("sub_id" => $id, "doctype" => "15", "kind" => "EC", "finaldoc" => "1", "post_approval_type" => $ppaid);
                                $getclerance = $obj->fetch_record_with_where("document_postapproval", $where);
                                if($getclerance){
                                    foreach($getclerance as $clear){
                                       echo '<br><a class="btn btn-default btn-xs" href="sec_dashboard_action.php?deletecccc=1&id='.$clear['file_id'].'&subid='.$clear['sub_id'].'" role="button"><span data-toggle="tooltip" title="DELETE" class="glyphicon glyphicon-remove" aria-hidden="true"></span></a> '.$clear['orig_filename'];
                                       echo ' <input id="ecpath" name="ecpath" type="hidden" value="'.$clear['path'].'">';
                                       $ecpath = $clear['path'];
                                    }
                                }
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6"><center><div class="alert alert-danger" role="alert">Please double check before approving.</div>
                                                ...
                                                ?>    
                                                    <button name="approvepropecpa" type="submit" class="btn btn-primary" <?php echo $ecc;?>>APPROVE</button> </center>
                                            </div>
                                            <div class="col-lg-3">
                                            </div>
                                        </div>

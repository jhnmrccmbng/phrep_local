  ...
  <body>
      <form action = "sec_dashboard_action.php?" method = "POST" enctype = "multipart/form-data" class="form-horizontal">
        ...
        <div class="container-fluid">
            <?php $id = (int) $_GET['id']; $idu = (int) $_GET['idu']; $evt = (int) $_GET['r'];?>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        <table class="table table-bordered table-condensed">
                            ...
                            <td style="height: 50px; width:250px;" rowspan="4"><center><h4><?php echo $eval['evaltype_desc'];?></h4></center></td>
                            <td>NEC Form No.</td>
                            ...
                            <tr>
                            <td>Version Date</td>
                            <td><?php echo date("d F Y",strtotime($eval['version_date']));?></td>
                            </tr>
                        ...
                        <table class="table table-condensed table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr style="height: 23px;">
                                <td style="width: 150px; height: 23px;"><strong>Reasons for Ethical Review</strong></td>
                                <td style="width: 216px; height: 23px;" colspan="3">
                                    <?php 
                                    echo '<ol>';
                                ...
                                <td bgcolor="#d3d3d3" style="width: 140px; height: 31px;" colspan="2">For Amendment of Informed Consent</td>
                                </tr>
                                
                                <tr style="height: 26px;">
                                <td style="width: 70px; height: 26px;"><strong>Revisions made involve which of the following?</strong></td>
                        ...
                        <h4><b>Comment/s of Reviewer: </b></h4>
                        <table class="table table-condensed table-bordered">
                            <?php
                                $ppaid = $obj->getmaxpropapp($id);
                                    $ans = $obj->gettingAnswerscommpa($idu,$id, $evt, $ppaid);
                                    if($ans){
                                        foreach($ans as $an){
                                            ?>
                                        <tr style="height: 31px;">
                        ...
                        <table class="table">
                            <tbody>
                                <tr>
                                    <td style="width: 363px;">&nbsp;<h4><b>Recommendation of Reviewer: </b></h4></td>
                                    <td style="width: 363px;">&nbsp;</td>
                                </tr>
                                <?php
                                date_default_timezone_set('Asia/Manila');
                                $ppaid = $obj->getmaxpropapp($id);
                                $geteval = $obj->getevaluationanswerpa($idu, $id, $ppaid, $evt);
                                if ($geteval) {
                                    foreach ($geteval as $ev) {
                                        ?>
                                        <tr>
                                            ...
                                            <td style="width: 10px; text-align: center;" colspan="3"><b>
                                                ...
                                                if($ev['decision'] == '1'){
                                                    ...
                                                    echo "NEEDS ADDITIONAL DOCUMENTS";                                                    
                                                }
                                                ...
                                                else if($ev['decision'] == '6'){
                                                    echo "TERMINATED";                                                    
                                                }
                                                else if($ev['decision'] == '7'){
                                                    echo "CONDUCT SITE VISIT";                                                    
                                                }

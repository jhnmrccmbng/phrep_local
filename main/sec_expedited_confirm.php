                            ...
                            <div class="panel-body">
                                ...
                                <?php 
                                    ...
                                    if($checkifassigned){
                                                ...
                                                if($checkChairman){
                                                    foreach($checkChairman as $row){
                                                        ...
                                                        echo '<div class="checkbox">
                                                            <label>
                                                            <input type="hidden" value="0" name="revchr">
                                                            <input type="checkbox" value="1" name="revchr">
                                                            <p data-toggle="tooltip" data-placement="bottom" title="Assign Chairman to review and evaluate">Reviewer</p>
                                                            </label>
                                                          </div>';
                                                    }
                                                }
                                        ...
                                        <div class="form-group">
                                          <label class="col-md-3 control-label" for="coreviewer">Reviewers</label>
                                          <div class="col-md-7">
<!--                                            <select id="coreviewer" name="coreviewer" class="form-control" required>
                                                <option value="">(Select Co-Reviewer)</option>-->
                                                <?php 
//                                                $id1 = "rec_list_id"; $id2 = "id"; $id3 = "phrepuser_id";
//                                                $where = array("a.type_id" => 2, "b.secretary" => $userid);
//                                                $checkChairman = $obj->selectChairman("rec_groups", "rec_list", "phrepuser", $id1, $id2, $id3, $where);
//                                                if($checkChairman){
//                                                    foreach($checkChairman as $row){
...
<!--                                            </select>
                                                  ...
                                                  <tr>
                                                      ...
                                                      <?php 
                                                        ...
                                                        if($checkChairman){
                                                            foreach($checkChairman as $row){
                                                                echo '<tr>';
                                                                echo '<td><input type="checkbox" name="rev[]" id="rev'.$row['puser'].'" value="'.$row['puser'].'"></td>';
                                                                echo '<td>'.$row['fname'].' '.$row['mname'].' '.$row['lname'].'</td>';
                                                                echo '</tr>';
                                                            }
                                                        }
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="startdate">Review Due Date</label>  
                                            <div class="col-md-7">

                                              <div id="sandbox-container">
                                                        <input type="text" class="form-control" name="duedate" value="" required readonly>
                                              </div>
                                        ...
                                        <div class="form-group">
                                          <label class="col-md-3 control-label" for="notetocoreviewer">Note to Reviewers</label>
                                          <div class="col-md-7">                     
                                            <textarea class="form-control" id="notetocoreviewer" name="notetocoreviewer" required></textarea>
                                          </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-md-7">
                                            <button id="confirmexpedited" name="assignexpedited" class="btn btn-primary">Assign</button>
                                            <a class="btn btn-default" href="sec_dashboard_action.php?deletertype=1&id=<?php echo $id;?>" role="button">Cancel</a>
                                          </div>
                                        </div>
                                <?php    }
                                ?>

          ...
          <div class="row">
              ...
              <div class="col-lg-10 tab-content">
                          ...
                          <div id="newapproved" class="tab-pane fade in active">
                              ...
                              <div class="panel-heading"><b>Approved  for year <?php echo $_GET['year']; ?></b>

                                <a href="sec_dashboard_active.php?#newapproved" class="pull-right" data-toggle="tooltip" title="Back"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span></a>
                              </div>
                              ...
                              <table class="table table-condensed table-bordered table-hover">
                                 ...
                                 <tr>
                                  ...
                                  $getmaxdoc = $obj->getMaxDocumentStat_new($userid, $year);
                                    if($getmaxdoc == ''){

                        ...
                        <?php }
                            ...
                            <div class="panel-body">
                              <form action = "sec_dashboard_action.php" method = "POST" enctype = "multipart/form-data" class="form">
                                  ...
                                  <h4>Upload Final Report Approval Letter:</h4>       
                                            <?php 
                                                $where = array("username" => $mi['username']);
                                                $getUserID = $obj->getUser("phrepuser", $where);
                                                if($getUserID){
                                            ...
                                            ?>
                                            <input id="times" name="times" type="hidden" value="1" placeholder="" class="form-control input-md">
                                            <input id="docname" name="docname" type="hidden" value="FinalReportApprovalLetter" placeholder="" class="form-control input-md">
                                            <input id="date" name="date" type="hidden" value="<?php $date;?>" placeholder="" class="form-control input-md">
                                            <input id="doctype" name="doctype" type="hidden" value="32" placeholder="" class="form-control input-md">
                                            <input id="submid" name="submid" type="hidden" value="<?php echo $_GET['id'];?>" placeholder="" class="form-control input-md">
                                            <input id="kind" name="kind" type="hidden" value="FRAL" placeholder="" class="form-control input-md">
                                            <?php $actual_link = "http://".$_SERVER['HTTP_HOST']."".$_SERVER['REQUEST_URI'].""; ?>
                                            <input id="urllink" name="urllink" type="hidden" value="<?php echo $actual_link;?>" placeholder="" class="form-control input-md">
                                            <input id="username" name="username" type="hidden" value="<?php echo $mi['username'];?>" placeholder="" class="form-control input-md">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <span class="btn btn-default btn-file">
                                                    <input id="attach" type = "file" name = "finalreportletter" />  
                                                    </span>                      
                                ...
                                $where = array("sub_id" => $id, "doctype" => "32", "kind" => "FRAL", "finaldoc" => "1", "post_approval_type" => $ppaid);
                                $getclerance = $obj->fetch_record_with_where("document_postapproval", $where);
                                if($getclerance){
                                    foreach($getclerance as $clear){
                                       echo '<br><a class="btn btn-default btn-xs" href="sec_dashboard_action.php?erase=1&id='.$clear['file_id'].'&subid='.$clear['sub_id'].'&loc=sec_approve_fr" role="button"><span data-toggle="tooltip" title="DELETE" class="glyphicon glyphicon-remove" aria-hidden="true"></span></a> '.$clear['orig_filename'];
                                       echo ' <input id="ecpath" name="ecpath" type="hidden" value="'.$clear['path'].'">';
                                       $ecpath = $clear['path'];
                                    }
                                }
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6"><center><div class="alert alert-danger" role="alert">Please double check before approving.</div>
                                                ...
                                                <?php 
                                                $getMaxRevisionAL = $obj->getMaxRevisionAL($id, "FRAL");
                                                $whereec = array("sub_id" => $id, "kind" => "FRAL", "revision" => $getMaxRevisionAL);
                                                ...
                                                ?>    
                                                    <button name="approvepropfrpa" type="submit" class="btn btn-primary" <?php echo $ecc;?>>APPROVE</button> </center>
                                            </div>
                                            <div class="col-lg-3">
                                            </div>
                                        </div>

                      ...
                      foreach($revised as $revi){
                          ...
                          if($stat){
                              foreach($stat as $status){
                                  if(($status[status_action]=='5')||($status[status_action]=='13')){
                                      echo '<div class="row">
                                                <div class="col-lg-12">
                            ...
                            <div class="panel-body">
                                <form action = "sec_dashboard_action.php" method = "POST" enctype = "multipart/form-data" class="form">
                                  ...
                                  <h4>Attached Decision Letter:</h4>       
                                            ...
                                            <input id="maxrl" name="maxrl" type="hidden" value="<?php echo $getmaxrl;?>"> 
                                        ...
                                        <?php
                                        $max = $obj->getmaxpropapp($id);
                                        $where = array("pid" => $max);
                                        $getreq = $obj->fetch_record_with_where("proposal_post_approval", $where);
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <input id="attach" type = "file" name = "<?php echo $namef;?>" require/>  
                                                </span>                      
                                        ...
                                        $where = array("sub_id" => $id, "doctype" => "16", "kind" => "RL", "finaldoc" => "1", "post_approval_type" => $getmaxppaid);
                                ...
                                <form action = "sec_dashboard_action.php" method = "POST" class="form">
                                    ...
                                    ?>
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <h4>Please mark a check for revision.</h4>
                                                    ...
                                                    if($getdocs){
                                                        foreach($getdocs as $doc){
                                                            echo '<tr>';
                                                                ...
                                                                echo '</td>';
                                                                echo '<td>'; 
                                                                    echo $doc['doctype_desc'];
                                                                echo '</td>';
                                                                echo '<td><center>'.$getnum = $obj->ordinalize($doc['revision']).'</center></td>';
                                                            echo '</tr>';
                                                        }
                                                    }
                                                    ?>
                                    ...
                                    <hr>                                    
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6"><center>
                                                <?php 
                                                $maxpp = $obj->getmaxpropapp($id);
                                                if(($obj->getifrlisthere($id, 'RL', $maxpp) == 0)){$disabled = "disabled";} else{$disabled = "";} 
                                                ?>    
                                                <button name="reviseproppost" type="submit" id="form-submit" class="btn btn-warning" <?php echo $disabled; ?>>REVISE</button> </center>
                                            </div>
                                            <div class="col-lg-3">
                                            </div>
                                        </div>

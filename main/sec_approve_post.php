                              ...
                              <form action = "sec_dashboard_action.php" method = "POST" enctype = "multipart/form-data" class="form">
                                                ...
                                                if($getid){
                                                    foreach($getid as $gcid){
                                                        ...
                                                        echo '<div class="form-group col-lg-12">
                                                                ...
                                                                <tr>
                                                                <td><a href="'.PREPEND_PATH.'sec_dashboard_action.php?delcpost=1&id='.$gcid[ec_id].'&subid='.$id.'"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a></td>
                                                                <td>'.$gcid[ec_start].'</td>
                                                                <td>'.$gcid[ec_end].'</td>
                                                                </tr>
                                                                </table>
                                  ...
                                  <h4>Attached Ethical Clearance:</h4>       
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <input id="attach" type = "file" name = "imagepostece" />  
                                                    </span>                      
                                                    <input id="attached" type = "submit" name="clearancepostece" class="btn btn-primary"/>
                                                </div>
                                            </div>
                                        </form>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <?php $getmxrq = $obj->getmaxrequesttimes($id); echo '<input id="maxrq" type="hidden" name="maxrq" value="'.$getmxrq.'">'; ?>
                                        <div class="row">
                                            <div class="col-lg-3">
                                            </div>
                                            <div class="col-lg-6"><center><div class="alert alert-danger" role="alert">Please double check before approving.</div>
                                                <?php if(($obj->getifrlisthere($id, 'EC') == 0)){$disabled = "disabled";} else{$disabled = "";} ?> 
                                                <button name="approvepropecpost" type="submit" class="btn btn-primary" <?php echo $disabled; ?>>APPROVE</button> </center>
                                            </div>
                                            <div class="col-lg-3">
                                            </div>
                                        </div>

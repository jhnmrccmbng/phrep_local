...
//                if($donereview == '0'){ 
           ...
           <form class="form-horizontal" role="form" action="rev_dashboard_action.php" method="POST">
                    ...
                    $where = array("sub_id" => $id, "revid" => $userid, "revform_id" => "3");
...
//                         
                           ...
                           foreach($getquestions as $key => $quest){
                               if($quest['revid'] == $userid){

                               		$incrementCount = $key + 1; 

                                    echo "<p class='questions'>".$incrementCount.".) ".$quest['qdesc']."<br>";
                                            ...
                                            if($quest['withtext'] == 1){
                                                    ...
                                                    if($getsub){
                                                        foreach($getsub as $suba){
                                                            echo '<div id="q'.$quest['aidq'].'" style="display:block">
                    ...
                    <div class="row"><br>
                        <div class="col-lg-12">
                            <button class="btn btn-primary btn-lg" type="submit" name="savereview-newversion" id="savereview-newversion" data-toggle="tooltip" title="You can return later to submit">Save</button>
...
function choices29() {
    if ((document.getElementById('inlineRadio29').checked)||(document.getElementById('inlineRadio129').checked)) {
        document.getElementById('q29').style.display = 'block';
        document.getElementById('t29').required = true;   
        
    }
    else{     
        document.getElementById('q29').style.display = 'block';
        // document.getElementById('t1').value = '';
        document.getElementById('t29').required = false;
    } 
...
$('#savereview-newversion').on('click',function(){

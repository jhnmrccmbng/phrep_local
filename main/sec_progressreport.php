      ...
      <div class="container-fluid">
        ...
        <!--<form class="form-horizontal" role="form" action="submission_action.php" method="POST">-->  
          ...
          <div class="row"><!--THIS IS THE FORM AREA-->
              ...
              <h1>Request for Continuing Reports<?php #echo $timee;?><span class="pull-right"><small><?php echo $obj->ordinalize($pid);?> Request</small></span></h1><hr>
                  ...
                  <div class="col-lg-4">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                if($getreq = $obj->fetch_record_with_where("sub_request",$where)){
                                    echo '<ol>';
                                    foreach($getreq as $req){
                                        $where = array(
                                            "id" => $req['sreq_id']
                                        );                              
                                        if($getsreq = $obj->fetch_record_with_where("sub_request_type", $where)){
                                            
                                            foreach($getsreq as $r){
                                                echo '<li>'.$r['srt_desc'].'</li>';
                                            }
                                        }
                                    }
                                    echo '</ol>';
                      ...
                      <div class="panel panel-default">
                        <div class="panel-body">
                          ...
                          <table class="table table-condensed table-bordered table-hover">
                                ...
                                echo '<tr><td colspan="2">'.$obj->ordinalize($maxbatch).' Batch</td></tr>';
                            ...
                            $num = count($myrow);
                               if($num>0){    
                                   foreach($myrow as $row){
                                       if (($row['status_action']=='7')||($row['status_action']=='8')||($row['status_action']=='9')||($row['status_action']=='19')){                          
                                            echo '<div class="row">
                                                        <div class="col-lg-4"></div>

          ...
          <div class="row">
              <div class="col-lg-6">
                  ...
                  foreach($ppaidfetch as $ppid){
                      ...
                      if($pptype == 1){$type_req = "47"; $type_name = "Appeal-DisapprovalEthicalClearance"; $kind = '1'; $status = '32';}
                      else if($pptype == 2){$type_req = "48"; $type_name = "Appeal-DisapprovalAmendments"; $kind = '2'; $status = '33';}
                      else if($pptype == 3){$type_req = "49"; $type_name = "Appeal-DisapprovalProgressReport"; $kind = '3'; $status = '34';}
                      else if($pptype == 4){$type_req = "50"; $type_name = "Appeal-DisapprovalFinalReport"; $kind = '4'; $status = '35';}
              ...
              <div class="col-lg-6">
                    ...
                    foreach($statss as $sts){
                        if(($sts["status_action"] == '32')||($sts["status_action"] == '33')||($sts["status_action"] == '34')||($sts["status_action"] == '35')){
                              ...
                              <div class="col-lg-12">           
                                  <fieldset> 
                                      ...
                                      ?>
                                        ...
                                        <input name="page" type="hidden" value="rev_appeal_postapproval">
...
//                                               echo ' <input id="ecpath" name="ecpath" type="hidden" value="'.$clear[path].'">';
                                               ...
                                               echo '<div class="alert alert-success" role="alert">
                                                        ...
                                                        <a href="#" data-toggle="modal" data-target="#confirm-deletesitedoc" data-href="researcher_action.php?erase=1&id='.$clear["file_id"].'&subid='.$subid.'&loc=rev_appeal_postapproval"><span class="glyphicon glyphicon-remove pull-right" aria-hidden="true"></span></a>
                                                    </div>';
...
//                                               $ecpath = $clear[path];
                          ...
                          <br>
                            <?php
                          echo '<a class="btn btn-primary btn-lg '.$disable.'" href="#" data-toggle="modal" data-target="#confirm-appeal" data-href="researcher_action.php?appeal=1&subid='.$subid.'&statact='.$status.'&u='.$userid.'&loc=rev_appeal_postapproval" role="button">Appeal</a>';
                            ?>
                        </form>

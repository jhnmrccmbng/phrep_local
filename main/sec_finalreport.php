      ...
      <div class="container-fluid">
        ...
        <!--<form class="form-horizontal" role="form" action="submission_action.php" method="POST">-->  
          ...
          <div class="row"><!--THIS IS THE FORM AREA-->
              ...
              <h1>Request for Final Report<span class="pull-right"><small><?php echo $obj->ordinalize($pid);?> Request</small></span></h1><hr>
              <div class="row">
                  <div class="col-lg-4">
                      ...
                      <?php
                        ...
                        ?>
                        <p><strong>Title: </strong><?php echo $ptitle; ?></p>
                            ...
                            $num = count($myrow);
                               if($num>0){    
                                   foreach($myrow as $row){
                                       if (($row['status_action']=='7')||($row['status_action']=='8')||($row['status_action']=='9')||($row['status_action']=='19')||($row['status_action']=='21')){                          
                                            echo '<div class="row">
                                                        <div class="col-lg-4"></div>

                            ...
                            if($getifsenticc){ ?>
                                <?php 
                                    ...
                                    foreach($pathfpi as $pf){
                                        $fp = $pf['path'];
                                        $datefpi = $pf['date_uploaded'];
                                    }
                                ?>
                            
                                <div class="panel panel-danger">
                                    <div class="panel-body">
                                        <h4>FPIC APPROVAL<small><span class="pull-right"><a href="<?php echo $fp; ?>">DOWNLOAD</a></span></small>
                                            <br> <small><?php echo date("M t, Y", strtotime($datefpi));?></small> 
                                        </h4>
                                    </div>
                                </div>
